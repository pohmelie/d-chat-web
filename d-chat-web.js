...
(function() {
  var Autocomplete, Dchat, History, bit32, bnet, bnutil, construct, convert, help_message, intro, java_socket_bridge_ready_flag, packets, ui, xsha1,
    __slice = [].slice,
  ...
  ui = (function() {
    ...
    ui.Tabs = (function() {
      ...
      Tabs.prototype.autosize = function() {
        ...
        height = $(this.tabs_id).outerHeight(true) + $(this.chat_id).outerHeight(true) + $(this.input_id).outerHeight(true) - $(this.chat_id).innerHeight() + 20;
  ...
  Dchat = (function() {
    function Dchat(tabs_id, chat_id, user_list_id, input_id, commands_prefix) {
      ...
      this.commands_list = ["echo", "connect", "disconnect", "reload", "autoscroll", "help", "tab-mode"];
    ...
    Dchat.prototype.chat_event = function(pack) {
      ...
      switch (pack.event_id) {
        ...
        case "ID_TALK":
        case "ID_EMOTE":
          return this.echo(["color-nickname", this.nicknames[pack.username]], ["color-delimiter", "*"], ["color-nickname", pack.username], ["color-delimiter", ": "], ["color-text", pack.text]);
        case "ID_CHANNEL":
