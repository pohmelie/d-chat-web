...
(function() {
  var Autocomplete, Autotrade, Calculator, Dchat, History, bit32, bnet, bnutil, construct, convert, help_message, intro, java_socket_bridge_ready_flag, packets, ui, xsha1,
    __slice = [].slice,
  ...
  Dchat = (function() {
    function Dchat(tabs_id, chat_id, user_list_id, input_id, commands_prefix) {
      ...
      this.commands_list = ["echo", "connect", "disconnect", "reload", "autoscroll", "help", "tab-mode", "autotrade-message", "autotrade-timeout", "autotrade-activity", "autotrade-start", "autotrade-stop", "autotrade-info", "calc"];
    ...
    Dchat.prototype.show_help = function() {
      return this.command("echo " + help_message);
    };
